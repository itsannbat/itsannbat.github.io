<div class="bg-white rounded-lg shadow-2xl p-4 m-5 w-3/5 mx-auto">
  <div class="flex items-center">
    ...
    <div>
      ...
      <br>
      <p class="text-sm text-gray-600">Besides codings, I enjoy hiking and reading, click on the Hobbies tab</p>
      <p class="text-sm text-gray-600">to find out more about that. I hope you enjoy the webiste!</p>
    </div>
  </div>
</div>