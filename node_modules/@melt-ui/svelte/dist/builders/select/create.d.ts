...
export declare function createSelect<Item extends Multiple extends true ? Array<unknown> : unknown = any, Multiple extends boolean = false>(props?: CreateSelectProps<Item, Multiple>): {
    elements: {
        ...
        option: import("../../internal/helpers/index.js").ExplicitBuilderReturn<{
            update: (updater: import("svelte/store").Updater<Item>, sideEffect?: ((newValue: Item) => void) | undefined) => void;
            set: (this: void, value: Item) => void;
            subscribe(this: void, run: import("svelte/store").Subscriber<Item>, invalidate?: import("svelte/store").Invalidator<Item> | undefined): import("svelte/store").Unsubscriber;
        }, (node: HTMLElement) => MeltActionReturn<SelectEvents['option']>, ($value: Item) => (props: SelectOptionProps<Item>) => {
        ...
        input: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[{
            ...
            set: (this: void, value: Item) => void;
            subscribe(this: void, run: import("svelte/store").Subscriber<Item>, invalidate?: import("svelte/store").Invalidator<Item> | undefined): import("svelte/store").Unsubscriber;
        }, import("svelte/store").Writable<boolean>, import("svelte/store").Writable<boolean>, import("svelte/store").Writable<string | undefined>], import("svelte/action").Action<any, any, Record<never, any>>, ([$value, $required, $disabled, $nameStore]: [Item, boolean, boolean, string | undefined]) => {
            type: string;
    ...
    states: {
        ...
        valueLabel: import("svelte/store").Readable<string | number | null>;
    };
    helpers: {
    ...
    options: {
        ...
        defaultValue?: import("svelte/store").Writable<Item | undefined> | undefined;
