...
import { addMeltEventListener, builder, createElHelpers, derivedVisible, effect, executeCallbacks, generateId, getPortalDestination, getTabbableNodes, isBrowser, isHTMLElement, isTouch, noop, overridable, sleep, styleToString, toWritableStores, } from '../../internal/helpers/index.js';
        ...
        action: (node) => {
            const unsub = executeCallbacks(addMeltEventListener(node, 'pointerenter', (e) => {
                ...
                if (isTouch(e))
                    return;
                get(handleClose)();
            }), addMeltEventListener(node, 'focus', () => get(handleOpen)()), addMeltEventListener(node, 'blur', () => get(handleClose)()), addMeltEventListener(node, 'touchstart', (e) => {
