...
export declare function createHoverCard(props?: CreateHoverCardProps): {
    elements: {
        trigger: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[{
            update: (updater: import("svelte/store").Updater<boolean>, sideEffect?: ((newValue: boolean) => void) | undefined) => void;
            set: (this: void, value: boolean) => void;
            subscribe(this: void, run: import("svelte/store").Subscriber<boolean>, invalidate?: import("svelte/store").Invalidator<boolean> | undefined): import("svelte/store").Unsubscriber;
        }], (node: HTMLElement) => MeltActionReturn<HoverCardEvents['trigger']>, ([$open]: [boolean]) => {
            role: "button";
        ...
        content: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[Readable<boolean>, import("svelte/store").Writable<string | HTMLElement | null>], (node: HTMLElement) => MeltActionReturn<HoverCardEvents['content']>, ([$isVisible, $portal]: [boolean, string | HTMLElement | null]) => {
