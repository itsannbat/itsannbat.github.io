...
export declare function createContextMenu(props?: CreateContextMenuProps): {
    elements: {
        menu: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[{
            update: (updater: import("svelte/store").Updater<boolean>, sideEffect?: ((newValue: boolean) => void) | undefined) => void;
            set: (this: void, value: boolean) => void;
            subscribe(this: void, run: import("svelte/store").Subscriber<boolean>, invalidate?: import("svelte/store").Invalidator<boolean> | undefined): import("svelte/store").Unsubscriber;
        }, import("svelte/store").Writable<HTMLElement | null>], (node: HTMLElement) => MeltActionReturn<ContextMenuEvents['menu']>, ([$rootOpen, $rootActiveTrigger]: [boolean, HTMLElement | null]) => {
            readonly role: "menu";
